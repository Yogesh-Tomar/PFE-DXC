        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(auth -> 
                auth
                    ...
                    .requestMatchers("/api/variable-actions/edit/**").permitAll()
                    
                    // Admin only endpoints
                    .requestMatchers("/api/profils/**").hasRole("ADMINISTRATEUR")
                    .requestMatchers("/api/audit/**").hasRole("ADMINISTRATEUR")
                    .requestMatchers("/api/dashboard/admin/**").hasRole("ADMINISTRATEUR")
                    .requestMatchers("/api/dashboard/**").hasRole("DIRECTEUR_GENERAL")
                    .requestMatchers("/api/dashboard/**").hasRole("COLLABORATEUR")
                    ...
                    .requestMatchers("/api/variable-actions/edit/**").hasAnyRole("ADMINISTRATEUR", "DIRECTEUR_GENERAL", "COLLABORATEUR")
